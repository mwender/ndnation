...
if ( !class_exists('NDNation_Update_Checker') ):
...
class NDNation_Update_Checker {
	 ...
	 *
	 * Returns either an instance of NDNation_Update, or NULL if there is
	 * no newer version available or if there's an error.
	 *
	 * @uses wp_remote_get()
	 *
	 * @param array $queryArgs Additional query arguments to append to the request. Optional.
	 * @return NDNation_Update
	 */
	public function requestUpdate($queryArgs = array()){
		...
		if ( ($code == 200) && !empty($body) ){
			$themeUpdate = NDNation_Update::fromJson($body);
	 ...
	 * successfully, the first argument passed will be an instance of  NDNation_Update. Otherwise,
	 * it will be NULL. The second argument will be the corresponding return value of
	 * wp_remote_get (see WP docs for details).
	 *
	 * The callback function should return a new or modified instance of NDNation_Update or NULL.
	 *
	 * @param callable $callback
	 * @return void
	 */
...
if ( !class_exists('NDNation_Update') ):
...
class NDNation_Update {
	...
	/**
	 * Create a new instance of NDNation_Update from its JSON-encoded representation.
	 *
	 * @param string $json Valid JSON string representing a theme information object.
	 * @return NDNation_Update New instance of NDNation_Update, or NULL on error.
	 */
