<?php
	$sched_link = get_bloginfo('url')  . '/' . $term_year_name. '-football-schedule';
?>
<div class="schedule-block">
	<table>
		<?php
			echo "<tr class=\"row sched-year-title\"><th colspan=\"3\"><h4>$term_year_name Football Schedule</h4></th></tr>";
			if($football_loop->have_posts()){
				while($football_loop->have_posts()){
					$football_loop->the_post();
	...
	<div class="text-center">
		<a class="btn" href="<?php echo $sched_link; ?>">Full <?php echo $term_year_name; ?> Schedule</a>
	</div>
</div>