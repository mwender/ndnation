<?php
	...
	// $media_label = get_field_object('media_links')['label'];
	// $site_label = get_field_object('site_links')['label'];
?>
						...
						<ul class="game-mi-items">	
							<?php
								while(have_rows('media_links')){
									...
									$link_target = get_sub_field('media_link_target')[0];
							?>
								<li class="game-mi-item">
									<a href="<?php echo $link; ?>"<?php echo (($link_target == 'yes') ? ' target="_blank"' : ''); ?>><?php echo $link_text; ?></a>
								</li>
							<?php
								}
							?>
						...
						<ul class="game-mi-items">
							<?php
								while(have_rows('site_links')){
									...
									$link_target = get_sub_field('site_link_target')[0];	
							?>
								<li class="game-mi-item">
									<a href="<?php echo $link; ?>"<?php echo (($link_target == 'yes') ? ' target="_blank"' : ''); ?>><?php echo $link_text; ?></a>
								</li>
